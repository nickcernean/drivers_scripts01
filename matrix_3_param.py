...
def sequence_caption_generator(input1, output1, input2):
    # while input1 not in [output1]:
    b = "Scene " + str(input1 + 1) + " Layer " + str(output1 + 1) + " Input " + str(input2 + 1) + " "
    return b
...
def data_generator(input1, output1, input2):
    # while input1 not in [output1]:
    d = "set," + str(input1) + ",42," + str(output1) + "," + str(input2) + "\n" + "\r"
...
def sequence_generator(input1, output1, input2):
    #  while input1 not in [output1] and output1 not in [input1]:
    a = str(sequence_name_generator())
    sequence_names.append(a)
    c = "            <Sequence Name=\"" + a + "\""
    c += " Caption=\"" + str(sequence_caption_generator(input1, output1, input2)) + "\""
    ...
    c += "              <Image />\n"
    c += "              <Command>\n"
    c += "                <Data1>" + data_generator(input1, output1, input2) + "</Data1>\n"
    c += "                <Data2 />\n"
    c += "                <Lock1 Value=\"0\" />\n"
    c += "                <Lock2 Value=\"0\" />\n"
    c += "              </Command>\n"
...
def matrix_generator(height, width, height2):
    result = ""
    for i in range(0, width):
        for j in range(0, height):
            for k in range(0, height2):
                result += sequence_generator(i, j, k)
