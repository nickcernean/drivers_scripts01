...
def sequence_caption_generator(input1, output1):
    b = "Output " + str(output1 + 1) + " Input " + str(input1 + 1) + ""
    return b
...
def data_generator(input1, output1):
    d = "Output " + str(input1 + 1) + " " + str(output1 + 1) + ""
...
def reply_data_generator(input1, output1):
    e = "s in " + str(output1 + 1) + " av out " + str(input1) + "!"
    # the following line will put the output in bytes
    e = bytes(e, 'utf-8')
    # this line transforms the command into HEX code
...
# feedback replay name

def reply_sequence_caption_generator(input1, output1):
    b = "Input " + str(output1 + 1) + str(input1 + 1)
    return b
...
def question_generator(count):
    e = "r av out " + str(count) + "!"  # <-------------- POSSIBLE CHANGE HERE
...
def feedback_sequence_generator(width, count):
    ...
    result += "\" Caption=\"Output " + str(count) + " status" + "\"" + " Mode=\"Pull\" UseHeaderFooter=\"True\">\n"
...
if __name__ == '__main__':
    ...
    feedback_sequence_generator(10, 10)
